...
def get_blog_list_common_data(request, blogs_all_list):
    ...
    page_number = request.GET.get('page', 1)  # 获取URL的页面参数
    ...
    #  获取当前分类下的博客数量
    blog_types_list = BlogType.objects.annotate(blog_count=Count('blog_blog'))
    ...
    context = {"page_of_blogs": page_of_blogs, "blog_types": blog_types_list,
               "blogs": blogs, "page_range": page_range, "blog_dates": blog_dates}
    return context
...
def blog_details(request, blog_id):
    ...
    context = {"blog": blog, 'previous_blog': previous_blog, 'next_blog': next_blog}

    response = render(request, 'blog/blog_details.html', context)  # 响应
